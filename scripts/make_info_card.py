...
# ===========================================================================
HOST = "aqib"   # shown as  aqib@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Co-Founder & CEO @ AScode Tech"),
    ("kv", "Edu", "BSCS, Univ. of Central Punjab"),
    ("kv", "Focus", "Web/app dev, automation, AI"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, WordPress"),
    ("kv", "Backend", "Node, Cloudflare Workers, D1"),
    ("kv", "AI / ML", "Chatbots, ATS scoring, trading bots"),
    ("kv", "Automation", "n8n, WooCommerce, WhatsApp"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built ResumeGrow -- ATS + career tools"),
    ("bul", "Shipped BizPlan AI and CVBuilder AI"),
    ("bul", "MT5 scalping bot, self-learning signals"),
]
